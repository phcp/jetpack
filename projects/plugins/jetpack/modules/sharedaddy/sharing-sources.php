...
abstract class Sharing_Source {
	...
	/**
	 * Build the HTML <a> element link for the given arguments.
	 *
	 * @param string       $url The URL for the href.
	 ...
	 * @param string|false $id The id to include in the data-shared attribute.
